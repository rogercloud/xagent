...
from ..services.task_lease_service import registered_task_lease

if TYPE_CHECKING:
    from ..services.task_orchestrator import TaskTurnPayload, _ClaimedTurn
                    ...
                    bg_task = asyncio.create_task(
                        task_execution_service.execute_resume_background(
                            ...
                            delivery_notifier=(
                                ...
                                else make_delivery_notifier(
                                    websocket, client_message_id
                                )
                            ),
                        )
                    )
